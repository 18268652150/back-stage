...
<script>
import {getDeptGateList,getFirm,getTree,getCompanyEntranceList,postCompanyEntranceChoice} from "../api/data"
export default {
    data(){
...
item.status = 1
    ...
    searchButton(){
      ...
      //  console.log(this.entrance);
        ...
        onSubmit(){
            getDeptGateList(this.pageQuery,this.fromData).then(res=>{
